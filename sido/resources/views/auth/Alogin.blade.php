        ...
        <div class="login-box-body logon">
            ...
            <form method="POST" action="{{ route('admin.login.submit') }}">
                ...
                <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                    <input id="email" type="email" class="form-control logon" placeholder="Email" name="email" value="{{ old('email') }}" required autofocus>
                         @if ($errors->has('email'))
                ...
                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                    <input  id="password" type="password" name="password" required class="form-control logon" placeholder="Password">
                ...
                {{-- <div class="row">
                    <!-- /.col -->
                    <div class="col-xs-12">
                        <button type="submit" class="btn btn-primary btn-block btn-flat logon">Sign In</button>
                        <br>
